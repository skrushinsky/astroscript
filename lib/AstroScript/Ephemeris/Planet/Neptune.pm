package AstroScript::Ephemeris::Planet::Neptune;
...
use AstroScript::MathUtils qw /frac ARCS/;
use AstroScript::Ephemeris::Planet qw/$NE/;
...
=head2 AstroScript::Ephemeris::Planet::Neptune->new

Constructor.

=head2 $self->heliocentric($t)

See description in L<AstroScript::Ephemeris::Planet>.
