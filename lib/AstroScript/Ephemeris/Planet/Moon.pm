package AstroScript::Ephemeris::Planet::Moon;
...
use AstroScript::Ephemeris::Planet qw/$MO/;
use AstroScript::MathUtils qw /frac sine ARCS reduce_deg/;
use AstroScript::Ephemeris::Pert qw /addthe/;
...
Child class of L<AstroScript::Ephemeris::Planet>, responsible for calculating
B<Moon> position.

=head1 METHODS

=head2 AstroScript::Ephemeris::Planet::Moon->new
